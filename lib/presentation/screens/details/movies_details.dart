...
import 'package:movies_app/presentation/screens/details/widget/MoreLikeThisWidget/more_like_this_Item.dart';
...
class MoviesDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => MoreLikeThisProvider()..getMoreLikeThis(), // التأكد من جلب البيانات
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Dora and the lost city of gold',
                          style: AppStyle.moviesDetailsTitle.copyWith(fontSize: 18),
                        ),
                        SizedBox(height: 8.h),
                        Text(
                          '2019  PG-13  2h 7m ',
